...
function LBQuickEditParticleEmitterStack::setProperty(%this, %object)
{
   ...
   for( %i = 0; %i < %count; %i++ )
   {
      ...
      %imageMap = %emitterStack.createT2DDatablockList("ImageMapOrAnimation", "Image", "t2dImageMapDatablock");
      %animation = %emitterStack.createT2DDatablockList("ImageMapOrAnimation", "Animation", "t2dAnimationDatablock");
