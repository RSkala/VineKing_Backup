//-----------------------------------------------------------------------------
// Particle Editor EffectGraph Field Class
...
function TGBEffectFieldList::initGraph(%this)
{
   ...
   // particlelife_scale
   %this.AddGraphEntry( "Particle Life Scale", "particlelife_scale", 0, 1, 0, 1 );   
   // quantity_scale
   %this.AddGraphEntry( "Quantity Scale", "quantity_scale", 0, 20, 0, 1 );     
   // sizex_scale
   ...
   // emissionforce_base
   %this.AddGraphEntry( "Emission Force Base", "emissionforce_base", -1000, 1000, 0, 1 );
   // emissionforce_var
   %this.AddGraphEntry( "Emission Force Variance", "emissionforce_var", 0, 2000, 0, 1 );   
   // emissionangle_base
   %this.AddGraphEntry( "Emission Angle Base", "emissionangle_base", -3600, 3600, 0, 1 );   
   // emissionangle_var
   %this.AddGraphEntry( "Emission Angle Variance", "emissionangle_var", 0, 720, 0, 1 );      
   // emissionarc_base
   %this.AddGraphEntry( "Emission Arc Base", "emissionarc_var", 0, 360, 0, 1 );      
   // emissionarc_var
...
function LBQuickEditContent::createParticleEffectToolbar( %this )
{
   ...
   %button = new GuiIconButtonCtrl() {
      ...
      iconBitmap = "~/levelEditor/gui/images/iconSave.png";
      sizeIconToButton = "1";
      ButtonMargin = "0 0";
      fieldsObject = %quickEditObj;
   };
   ...
   %button = new GuiIconButtonCtrl() {
      ...
      iconBitmap = "~/levelEditor/gui/images/iconOpen.png";
      sizeIconToButton = "1";
      ButtonMargin = "0 0";
      fieldsObject = %quickEditObj;
   };
