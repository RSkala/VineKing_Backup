...
function destroyLevelEditor()
{
   ...
   $Game::ProductName = "iTorque 2D v1.4.1";   
...
//
   ...
   //%this.addMenuItem("Help", "Sign-up for TGB Announcements", "gotoWebpage(\"http://www.garagegames.com/developer/torque/t2d/\");");
   //%this.addMenuItem("Help", "-");
   //%this.addMenuItem("Help", "GarageGames Community Page", "gotoWebpage(\"http://www.garagegames.com/mg/whatsnew/\");");
   //%this.addMenuItem("Help", "TGB Developer Forums", "gotoWebpage(\"http://www.garagegames.com/mg/forums/result.area.php?qa=42\");");
