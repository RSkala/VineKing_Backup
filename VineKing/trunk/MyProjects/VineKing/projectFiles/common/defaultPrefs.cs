...
// RKS NOTE: This is where the default volumes are changed
$pref::Audio::masterVolume   = 1.0;

// RKS NOTE: I think the indexes here start at 1, and should actually start at $pref::Audio::channelVolume0, but I don't want to change it at this point.
$pref::Audio::channelVolume1 = 1.0; // BGM Looping
$pref::Audio::channelVolume2 = 1.0; // BGM NonLooping
$pref::Audio::channelVolume3 = 1.0; // Sound Effects
...
// Audio profiles for default - RKS NOTE: I don't think these are used by Torque at all.
$pref::Audio::sfxVolume		= 0.8; //0.8;
$pref::Audio::musicVolume	= 0.8; //0.8;
