...
//---------------------------------------------------------------------------------------------
$Project::Game::CommonVersion = 114;

//---------------------------------------------------------------------------------------------
// initializeCommon
// Initializes common game functionality.
//---------------------------------------------------------------------------------------------
$Project::Game::ConsoleBind = "ctrl tilde";
function initializeCommon()
{
   ...
   initializeCanvas( $Project::Game::ProductName );
   
   // Start up the audio system.
   if( $Project::Game::UsesAudio )
      initializeOpenAL();
   ...
   //Canvas.setCursor(DefaultCursor);	// RKS: Hide the cursor
   //Canvas.showCursor();				// RKS: Hide the cursor
