...
{
   // TODO: paxorr: get double click events straight from the system & adjust dependant code
   //   see: http://msdn.microsoft.com/library/en-us/winui/winui/windowsuserinterface/userinput/mouseinput/aboutmouseinput.asp
