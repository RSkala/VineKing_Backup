...
{
	// RKS: This is for debugging where unregisterObject() is called (to see what gets deleted between levels)
	//dPrintf( "registerObject() being called for %s\n", getName() );
...
{
	// RKS: This is for debugging where unregisterObject() is called (to see what gets deleted between levels)
	//dPrintf( "unregisterObject() being called for %s\n", getName() );
