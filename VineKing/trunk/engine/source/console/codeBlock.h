...
public:
   ...
   //-Mat this compiles a DSO, but instead of saving a filename, returns a buffer to it
   ...
   const char *exec(U32 offset, const char *fnName, Namespace *ns, U32 argc, 
	...
	//-Mat for clearing used variables
   Vector<Dictionary::Entry*> mUsedVars;
   void resetUsedEntries( Namespace *,StringTableEntry );
   void addUsedVariable( Dictionary::Entry *, StringTableEntry );
};
