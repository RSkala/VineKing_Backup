...
class Stream;
class DataChunker;
//-Mat size of the comsole dataChunker
#define CONSOLE_ALLOCATOR_SIZE			(65536 * 2)
...
//-Mat our magic number for later reference (bits are swapped when writing to file)
#define PUAP_DSO_NULL_VALUE (U32)(0xFEBEDADE)
#define PUAP_NULL_VALUE	0xDEADBEEF
