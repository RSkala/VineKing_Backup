...
#include "console/compiler.h"
	...
	#define NODE_SIZE_VARNODE								(3 + 1)
	#define NODE_SIZE_VARNODE_REQSTRING						(6 + 1)
	...
	#define NODE_SIZE_CONSTANTNODE							(2 + 1)
	#define NODE_SIZE_CONSTANTNODE_REQSTRING				(2 + 1)
	#define NODE_SIZE_CONSTANTNODE_REQNONE					(0 + 1)

	#define NODE_SIZE_ASSIGNEXPRNODE						(3 + 1)
	#define NODE_SIZE_ASSIGNEXPRNODE_ARRARYINDEX			(6 + 1)
	#define NODE_SIZE_ASSIGNEXPRNODE_ARRARYINDEX_REQSTRING	(8 + 1)

	#define NODE_SIZE_ASSIGNOPEXPRNODE						(8 + 1)
	#define NODE_SIZE_ASSIGNOPEXPRNODE_ARRAYINDEX			(5 + 1)

	#define NODE_SIZE_FUNCCALLEXPRNODE						(5 + 2)

	#define NODE_SIZE_SLOTACCESSNODE						(1 + 1)
	...
	#define NODE_SIZE_SLOTASSIGNNODE						(1 + 1)
	#define NODE_SIZE_SLOTASSIGNNODE_REQSTRING				5
	#define NODE_SIZE_SLOTASSIGNNODE_ARRAYEXPR				3

	#define NODE_SIZE_SLOTASSIGNOPNODE						(6 + 1)
	#define NODE_SIZE_SLOTASSIGNOPNODE_ARRAYEXPR			(9 + 1)

	#define NODE_SIZE_OOBJECTDECLNODE_SUBOBJECT_NAME		2
	#define NODE_SIZE_OOBJECTDECLNODE_SUBOBJECT				(10 + 1)

	#define NODE_SIZE_OBJECTDECLNODE						2

	#define NODE_SIZE_FUNCTIONDECLSTMTNODE					(8 + 3)
	#define NODE_SIZE_FUNCTIONDECLSTMTNODE_PER_ARG			(1)
#else
