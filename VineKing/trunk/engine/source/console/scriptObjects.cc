...
bool ScriptObject::onAdd()
{
   ...
   //Con::executef(this, 2, "onAdd", Con::getIntArg(getId())); // RKS:  I removed this script call
   return true;
}
...
void ScriptObject::onRemove()
{
  ...
  // Con::executef(this, 2, "onRemove", Con::getIntArg(getId())); // RKS:  I removed this script call
