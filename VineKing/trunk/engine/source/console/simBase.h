...
protected:
   ...
   static bool setProtParent(void* obj, const char* data);
...
protected:
  ...
  public:
   ...
   virtual void copyTo(SimObject* object);
	...
	// RKS: I added this here, so t2dSceneObject could inherit it
	virtual void OnPositionTargetReached() { }
...
// [tom, 3/9/2007] Pull in definitions for SimSet and SimGroup. See comment in simSet.h
...
public:
   ...
   SimDataBlock();
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// RKS: DO NOT LEAVE THIS IN HERE -- THIS IS TO DEBUG WHEN AND HOW SIMDATABLOCKS ARE DELETED (IF EVER)
	~SimDataBlock();
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace Sim
{
   ...
   U32 schedule( U32 time, SimObject *object, U32 argc, const char **argv, bool onObject = true );
