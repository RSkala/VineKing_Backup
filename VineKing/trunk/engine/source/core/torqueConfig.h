...
#define TORQUE_GAME_NAME            "iTorque 2D v1.4.1"

/// Human readable version string.
#define TORQUE_GAME_VERSION_STRING  "iTorque 2D v1.4.1"
...
//#define TORQUE_DEBUG_GUARD  // RKS: This is supposed to help track down memory issues, but this doesn't seem to help for shit.
...
//#  define TORQUE_ENABLE_PROFILER
#  undef TORQUE_ENABLE_PROFILER // RKS: This could be causing a "overflow in profiler" error due to mismatched PROFILE_START and PROFILE_ENDs, so I am disabling this.
#endif
