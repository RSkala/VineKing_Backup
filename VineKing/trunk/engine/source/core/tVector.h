...
class Vector
{
	public: // RKS:  I ADDED THIS 'public' SHIT TO CHECK FOR THE CRASH BETWEEN LEVELS!
	bool resize_public( U32 ); // RKS: I added this
	//U32 GetArrayAddress() { return mArray; } // JUST USE THE FUNCTION address()!!!
...
//bool resize_public( U32 ); // RKS: I added this
template<class T> inline bool Vector<T>::resize_public( U32 uElementCount )
{
	return resize( uElementCount );
}
