...
struct Platform
{
   ...
   //Luma: Adding fundamental file find function
...
public:
   ...
   /// Returns the full path to the torque executable.
   ...
   // CHRIS: Batch file launch function:
   ...
   // FIXME: paxorr: document these: getLoginPassword() & setLoginPassword()
   ...
   // FIXME: paxorr: document these: stringToFileTime() & fileTimeToString()
   ...
   // This is a simple c printf wrapper.
...
//%PUAP% -Mat adding function for converting an int to string
