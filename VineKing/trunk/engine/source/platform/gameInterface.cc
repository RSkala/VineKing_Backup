...
int GameInterface::main(int argc, const char** argv)
{
...
bool GameInterface::mainInit(int argc, const char **argv)
{
   return false;
}
...
void GameInterface::mainShutdown()
{
}
...
void GameInterface::processScreenTouchEvent(ScreenTouchEvent* event) // RKS NOTE: I changed this to have the actual parameter
{  
