...
#import "iPhoneTextEntryController.h"
#include "platformiPhone/iPhoneTextEntry.h"
 
@implementation iPhoneTextEntryController
...
- (void)onFinished: (id)sender
{
	...
	iPhoneTextEntry::onUserTextFinished(userCanceled, str);
