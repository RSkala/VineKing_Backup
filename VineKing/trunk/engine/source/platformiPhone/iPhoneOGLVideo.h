...
#ifndef _iPhoneOGLVIDEO_H_
#define _iPhoneOGLVIDEO_H_
...
//struct EAGLContext; // RKS NOTE: This is causing a compile error - "Redefinition of 'EAGLContext' as a different kind of symbol.
/*
