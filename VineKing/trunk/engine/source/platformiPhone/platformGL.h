...
#define IPHONE_DEFAULT_RESOLUTION_X		480
#define IPHONE_DEFAULT_RESOLUTION_Y		320

#define IPHONE_MAX_RESOLUTION_X			1024
#define IPHONE_MAX_RESOLUTION_Y			768

#define IPHONE_DEFAULT_RESOLUTION_BIT_DEPTH	32

#define IPHONE_SCREEN_PORTRAIT			0
#define IPHONE_SCREEN_LANDSCAPE			1
#define IPHONE_SCREEN_RIGHT_SIDE_UP		3
#define IPHONE_SCREEN_UPSIDE_DOWN		4


/// Allows outline mode drawing via a function pointer swapping trick.
/// Must be included AFTER all the OpenGL headers.
#include "platformiPhone/iPhoneOutlineGL.h"
