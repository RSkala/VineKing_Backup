...
#include <unistd.h> // RKS: This was added using this forum as a guideline: http://www.torquepowered.com/community/resources/view/19979

#pragma message("time code needs eval -- may not be accurate in all cases, and might cause performance hit.")
//#include <unistd.h> // RKS: I commented out because of above comment (probably wasnt here originally)
//--------------------------------------
...
//--------------------------------------
static void _iPhoneUpdateSleepTicks()
{
