...
void iPhoneInstallCarbonEventHandlers(void);

/// Remove all event handlers, except the alert event handlers.
void iPhoneRemoveCarbonEventHandlers(void);
...
void iPhoneInstallTorqueCarbonEventHandlers(void);
...
void iPhoneSendTorqueEventToMain( U32 eventKind, void* userData = NULL );
