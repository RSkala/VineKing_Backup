...
#import "iPhoneInterfaceWrapper.h" // RKS NOTE: I added this. In order for this to compile, I had to change the name from Facebook.m to Facebook.mm
...
- (void)authorize:(NSArray *)permissions
  ...
  //[self authorizeWithFBAppAuth:YES safariAuth:YES];
	[self authorizeWithFBAppAuth:NO safariAuth:NO]; // RKS NOTE: I changed this according to: http://stackoverflow.com/questions/5783782/fbdidlogin-not-called-ios
}
 ...
 *   by SDK, NO otherwise.
 */
- (BOOL)handleOpenURL:(NSURL *)url { // RKS TODO:  NEED TO IMPLEMENT THIS HANDLEOPENURL SHIT
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// FBSessionDelegate - RKS NOTE: I added this
...
- (void)fbDidLogin
{
	NSLog( @"FBSessionDelegate::fbDidLogin" );
	
	FacebookWrapper::OnLogIn();
}
...
- (void)fbDidLogout
{
	NSLog( @"FBSessionDelegate::fbDidLogout" );
