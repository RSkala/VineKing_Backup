...
//#import "iPhoneInterfaceWrapper.h" // RKS NOTE: I added this 2011/08/01
...
{
	NSLog( @"FBDialog::webView:shouldStartLoadWithRequest:navigationType:" );
...
{
	NSLog( @"FBDialog::webViewDidFinishLoad:" );
...
{
	NSLog( @"FBDialog::dismissWithSuccess:animated:" );
...
{
	NSLog( @"FBDialog::dismissWithError:animated:" );
...
{
	NSLog( @"FBDialog::dialogWillAppear" );
}
...
{
	NSLog( @"FBDialog::dialogWillDisappear" );
}
...
{
	NSLog( @"FBDialog::dialogDidSucceed: URL: %@", [url absoluteString] );
...
{
	NSLog( @"FBDialog::dialogDidCancel:" );
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// RKS NOTE: I added these methods 2011/08/01

// Called when the dialog succeeds and is about to be dismissed.
- (void) dialogDidComplete: (FBDialog *)dialog
{
	NSLog( @"FBDialog::dialogDidComplete:" );
}
...
{
	NSLog( @"FBDialog::dialogCompleteWithUrl:" );
}
...
{
	NSLog( @"FBDialog::dialogDidNotCompleteWithUrl:" );
}
...
{
	NSLog( @"FBDialog::dialogDidNotComplete:" );
}
...
{
	NSLog( @"FBDialog::dialog:didFailWithError:" );
}

//------------------------------------------------------------------------------------------------------------------------------------------------------------------------

@end // @implementation FBDialog
