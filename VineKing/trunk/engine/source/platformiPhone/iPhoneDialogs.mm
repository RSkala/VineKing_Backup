...
static FileDialogFileExtList* _iPhoneGetFileExtensionsFromString(const char* filter)
{
...
static FileDialogFileTypeList* _iPhoneGetFileTypesFromString(const char* filter)
{
   ...
   for( ; *place; place++)
   {
      ...
      *place = '\0';
      ...
      else
      {
         ...
         list.exts.push_back(_iPhoneGetFileExtensionsFromString(token));
      }
