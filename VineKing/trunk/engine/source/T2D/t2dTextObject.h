...
#ifndef _T2D_TEXT_OBJECT_H_
#define _T2D_TEXT_OBJECT_H_
...
//-----------------------------------------------------------------------------
/// 2D scene object that renders a text string.
/// 
/// Future Additions:
/// Funky text rendering like drawing in an arc.
/// Support for bold, italic, underline, etc.
/// Support for multiple fonts in a single object.
//-----------------------------------------------------------------------------
...
public:
   ...
   S32 getFontSize( U32 index ) const { if( index < getFontSizeCount() ) return mFonts[index].height; return 0; };
   /// @}
   ...
   void setCursorPosition( t2dVector worldPos );
   ...
   S32 getCharacterPosition( t2dVector worldPos );
...
private:
   ...
   t2dVector getSizeRatio( GFont* font ) const;
   /// @}
   ...
   /// @{
   static bool setText( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setText( data ); return false; }
   static const char* getText( void* obj, const char* data );

   static bool setFont( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setFont( data ); return false; }
   static const char* getFont( void* obj, const char* data ) { return static_cast<t2dTextObject*>( obj )->getFontName(); }

   static bool setFontSizes( void* obj, const char* data );
   static const char* getFontSizes( void* obj, const char* data );

   static bool setWordWrap( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setWordWrap( dAtob( data ) ); return false; };
   static bool setTextAlign( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setCharactersDirty(); return true; };
   static bool setLineHeight( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setLineHeight( dAtof( data ) ); return false; };
   static bool setAspectRatio( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setAspectRatio( dAtof( data ) ); return false; };
   static bool setLineSpacing( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setLineSpacing( dAtof( data ) ); return false; };
   static bool setCharacterSpacing( void* obj, const char* data ) { static_cast<t2dTextObject*>( obj )->setCharacterSpacing( dAtof( data ) ); return false; };
   /// @}
...
public:
   ...
   F32 getAlpha();
   void getTextSize(t2dVector *pSize);
};

#endif //_T2D_TEXT_OBJECT_H_
